...
public class ResponseUtil {
    public static  ApiResponse  success (int statusCode, String message, Object data , Object metadata){
        return new ApiResponse(true, statusCode, message,null,  LocalDateTime.now(ZoneId.of("Africa/Lagos")), data, metadata);
    }

    public static ApiResponse error (int statusCode, String message , String details,  Object data){
        return new ApiResponse(false, statusCode, message, details, LocalDateTime.now(ZoneId.of("Africa/Lagos")), data, null);
    }
}
